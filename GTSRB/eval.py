...
def main():
    ...
    dataloader = dataset.GTSRB

    testset_01 = dataloader(root_dir='./data', train=False, transform=transform_01, y_target=args.y_target)
    testset_02 = dataloader(root_dir='./data', train=False, transform=transform_02, y_target=args.y_target)
    testset_03 = dataloader(root_dir='./data', train=False, transform=transform_03, y_target=args.y_target)
    testset_04 = dataloader(root_dir='./data', train=False, transform=transform_04, y_target=args.y_target)
    testset_05 = dataloader(root_dir='./data', train=False, transform=transform_05, y_target=args.y_target)
    testset_06 = dataloader(root_dir='./data', train=False, transform=transform_06, y_target=args.y_target)
    testset_07 = dataloader(root_dir='./data', train=False, transform=transform_07, y_target=args.y_target)
    testset_08 = dataloader(root_dir='./data', train=False, transform=transform_08, y_target=args.y_target)
    testset_09 = dataloader(root_dir='./data', train=False, transform=transform_09, y_target=args.y_target)
    testset_1 = dataloader(root_dir='./data', train=False, transform=transform_1, y_target=args.y_target)
